...
```{r eestiintsidents, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r eestipaikmed, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r sagedasemadpaikmed, echo=FALSE, warning=FALSE, message=FALSE}
kasv %>%
  filter(!grepl("^ ?([[:punct:]]+)|Kõik paikmed", Paige)) %>% 
